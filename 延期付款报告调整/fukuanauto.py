...
def yqskbg_click(wd):
    ...
    element_1.click()
    #点击延期付款报告
    element_1 = wd.find_element(By.XPATH,'//*[@id="res13073c56-16712889dd6-81d76f67e9fa75bc16134518e029baa9"]')
    element_1.click()
    #点击延期付款调整
    element_1 = wd.find_element(By.XPATH,'//*[@id="res13073c56-1671288a465-81d76f67e9fa75bc16134518e029baa9"]')
    element_1.click()
...
def save_sheet(workbook):
    ...
    workbook.save(path +'\kuan_complete.xlsx')
...
def main_work(ah,ws,readws,i):
    try:
        ...
        #复制金额
        element_1 = ah.wd.find_element(By.XPATH,'//*[@id="page-0"]/div[1]/table/tbody/tr/td[5]/nobr')
        text = element_1.text
        ...
        element_1.click()
        #写入日期
        element_1 = ah.wd.find_element(By.XPATH,'//*[@id="page-0"]/div[2]/table/tbody/tr/td[2]')
...
def excl_job(ah):
    try:
        ...
        path = os.path.dirname(os.path.realpath(__file__))
        print(path)
        workbook = load_workbook(path + '\kuan.xlsx',data_only=True)
        readws = workbook.active
        workbooknew = load_workbook(path +'\kuan.xlsx')
